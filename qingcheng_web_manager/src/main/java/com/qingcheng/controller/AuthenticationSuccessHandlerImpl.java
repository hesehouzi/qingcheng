...
public class AuthenticationSuccessHandlerImpl implements AuthenticationSuccessHandler {
    ...
    @Reference
    private LoginLogService loginLogService;//远程注入loginLogService
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Authentication authentication) throws IOException, ServletException {
        ...
        String loginName = authentication.getName();//通过身份认证对象获得登录名
        String ip = httpServletRequest.getRemoteAddr();//获得登录ip地址

        LoginLog loginLog=new LoginLog();//创建LoginLog对象
        ...
        System.out.println("location:"+WebUtil.getCityByIP(ip));
        System.out.println("=================");
